    ...
    div [ class "row" ]
        [ Html.form [ class "col s12", onSubmit Submit ]
            [ div [ class "input-field col s12" ]
                [ input [ class "validate", id "email", name "email", value model.email, onInput EmailChange, required True, type_ "text" ] []
                , label [ for "email" ] [ text "Email Address" ]
                ]
            , div [ class "input-field col s12" ]
                [ input [ class "validate", id "password", name "password", value model.password, onInput PasswordChange, required True, type_ "password" ] []
